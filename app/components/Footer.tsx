function Footer() {
  return (
    <footer className="footer">
      <a href="https://github.com/your-profile" target="_blank" className="links git" rel="noreferrer">
      ...
      <a href="https://rs.school/courses/reactjs" target="_blank" className="links" rel="noreferrer">
        RS School
      </a>
    </footer>
  );
